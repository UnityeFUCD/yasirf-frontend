...
import { OfferStarIcon } from "@/components/Icons/HomeIcon";
import { ChevronRight } from "lucide-react";
import PropTypes from "prop-types";

const OffersCard = ({ data }) => {
  return (
    <div className="text-white w-full rounded-lg overflow-hidden relative border border-transparent hover:border-primaryColor transition-all duration-300">
      {/* <div className="relative">
        ...
        /> 
        <div className="absolute top-5 left-0 flex items-center gap-2 ml-3">
          <p className="flex items-start gap-1 bg-primaryColor py-0.5 px-3 rounded-full text-black font-semibold text-xs">
            <span>
              <svg
          ...
          <p className="flex items-center gap-1 bg-primaryColor/20 backdrop-blur-sm py-0.5 px-3 rounded-full text-primaryColor border border-primaryColor/40 font-medium text-xs">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="15"
        ...
        <div className="absolute top-0 w-full h-full bg-gradient-to-b from-transparent to-black/80" />
        <div className="absolute top-[40%] bg-gradient-to-t from-gray-700/70 to-transparent rounded-lg p-2 h-[180px] w-full">
          <h3 className="font-bold text-xl">{data?.name}</h3>
          <div className="flex flex-col justify-between h-[130px]">
            <div>
              {data?.contents?.features?.map((f, idx) => (
            ...
            <div className="mt-4 flex items-center justify-between ">
              ...
              <button className="bg-primaryColor px-2 py-2 rounded-full shadow-primaryColor/60 shadow-lg">
                {" "}
      ...
      <figure className="w-full aspect-[267/300]">
        <img
          src={data?.image?.props?.src}
          alt="image"
          className="w-full h-full rounded-xl"
      ...
      <div className=" absolute top-3 left-3 right-3 bottom-3 flex flex-col justify-between">
        ...
        <div className="rounded-lg p-2 h-[180px] w-full relative z-20">
          <h3 className="font-bold text-xl">{data?.name}</h3>
          <div className="flex flex-col justify-between h-[130px]">
            <div>
              {data?.contents?.features?.map((f, idx) => (
